...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( ChapterEntity chapter,  List<VerseWithDetailsEntity> verses,  Set<int> bookmarkedVerseIds,  bool showTranslation,  int? playingVerseId,  bool isAudioLoading)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
return loaded(_that.chapter,_that.verses,_that.bookmarkedVerseIds,_that.showTranslation,_that.playingVerseId,_that.isAudioLoading);case _Error() when error != null:
...
class _Loaded implements MuhudState {
  const _Loaded({required this.chapter, required final  List<VerseWithDetailsEntity> verses, required final  Set<int> bookmarkedVerseIds, required this.showTranslation, this.playingVerseId, this.isAudioLoading = false}): _verses = verses,_bookmarkedVerseIds = bookmarkedVerseIds;
...
@override
int get hashCode => Object.hash(runtimeType,chapter,const DeepCollectionEquality().hash(_verses),const DeepCollectionEquality().hash(_bookmarkedVerseIds),showTranslation,playingVerseId,isAudioLoading);

@override
String toString() {
  return 'MuhudState.loaded(chapter: $chapter, verses: $verses, bookmarkedVerseIds: $bookmarkedVerseIds, showTranslation: $showTranslation, playingVerseId: $playingVerseId, isAudioLoading: $isAudioLoading)';
}
...
@useResult
$Res call({
 ChapterEntity chapter, List<VerseWithDetailsEntity> verses, Set<int> bookmarkedVerseIds, bool showTranslation, int? playingVerseId, bool isAudioLoading
});
...
/// Create a copy of MuhudState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? chapter = null,Object? verses = null,Object? bookmarkedVerseIds = null,Object? showTranslation = null,Object? playingVerseId = freezed,Object? isAudioLoading = null,}) {
