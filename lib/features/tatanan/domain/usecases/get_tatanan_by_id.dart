...
@injectable
class GetTatananById {
  const GetTatananById(this._repository);

  final TatananRepository _repository;

  Future<Either<Failure, TatananEntity>> call(String tatananId) =>
      _repository.getTatananById(tatananId);
}
